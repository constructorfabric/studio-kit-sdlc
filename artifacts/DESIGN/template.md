...
{Optional: Describe deployment topology — how components are deployed, network layout, infrastructure.}

- [ ] `p3` - **ID**: `cpt-{system}-topology-{slug}`
